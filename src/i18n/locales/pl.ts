...
const pl: Translations = {
  ...
  mermaidOpeningDelimiter: 'Otwierajacy delimiter Mermaid',
  mermaidClosingDelimiter: 'Zamykajacy delimiter Mermaid',
  mermaidDelimiterHint: 'Uzywane przy odczycie i zapisie diagramow Mermaid, np. ```mermaid / ``` albo :::mermaid / :::.',
